...
async def test_antpathmatcher_basic():
    ...
    assert (
        matcher.match("com/t?st.jsp", "com/tst.jsp") is False
    ...
    assert (
        matcher.match("com/*.jsp", "com/sub/test.jsp") is False
    )  # (doesn't cross path boundaries)
    ...
    # Complex patterns
    assert matcher.match("org/demo/**/*.jsp", "org/demo/views/home.jsp") is True
    assert (
        matcher.match("org/demo/**/*.jsp", "org/demo/templates/views/home.jsp") is True
    )
